...
function BlogsPageSmallComponent2({ blog, ready }) {
          ...
          <div className='blogsPageSmallCompContainer'>
               ...
               <div className='top_s'>
                    <ReactPlaceholder showLoadingAnimation={true} customPlaceholder={<BlogPlaceholder2 />} type='media' ready={ready} >
                         <Link to={`/blogs/${blogg.id}`}><img className='blog__img' src={blogg.photo} alt="" /></Link>
                    </ReactPlaceholder>
               ...
               <div className='bottom_s'>
                    <ReactPlaceholder showLoadingAnimation={true} type='text' ready={ready} rows={1} color='#CFCFCF'>
                         <Link to={`/blogs/${blogg.id} `}><p className='title'>{cookies.get('i18next') === 'ar' ? blogg.title__ar : (cookies.get('i18next') === 'fr' ? blogg.title__fr : blogg.title__en)} </p> </Link>
                    </ReactPlaceholder>
                    <ReactPlaceholder showLoadingAnimation={true} type='text' ready={ready} rows={1} color='#CFCFCF'>
                         <p>{blogg.author}</p>
                    </ReactPlaceholder>
...
export default BlogsPageSmallComponent2
