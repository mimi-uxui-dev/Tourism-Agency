...
import img from '../../assets/img/Blogs/cover.png'

function LatestCardBlog({ data }) {
          ...
          <div className='latestCard__container'>
               <div className='top'>
                    ...
                    <div className='top_'>
                         ...
                         <div><img src={flag} alt="" /><span> {t('blog')} </span> </div>
                    </div>
               </div>
               <div className='bottom'>
                    <Link to={`/blogs/${data.id}`} >
                         <h2>
                              {cookies.get('i18next') === 'ar' ? data.title__ar : (cookies.get('i18next') === 'fr' ? data.title__fr : data.title__en)}
                         </h2>
                    </Link>
                    <h6> {data.author} </h6>
               </div>
